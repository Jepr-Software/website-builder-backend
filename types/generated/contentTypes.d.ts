...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    urlSlug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    sectionComponents: Schema.Attribute.DynamicZone<
      [
        'section-component.blog-content-only',
        'section-component.blog-image-with-text',
        'section-component.blog-image-only',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    author: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    urlSlug: Schema.Attribute.UID<'pageTitle'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
